!function(t) {
    ...
    n.Utils.isInView = function(t, e) {
        ...
        c + o.height() >= a && c - e.topoffset <= a + n.$win.height() && l + o.width() >= s && l - e.leftoffset <= s + n.$win.width()
    }
    ,
            ...
            var t = requestAnimationFrame(function() {
                var i = {
                  ...
                  , e = function() {
                    ...
                    i.x == o && i.y == s || (o != i.x ? i.dir.x = o > i.x ? 1 : -1 : i.dir.x = 0,
                ...
                new n.support.mutationobserver(function(t) {
                    ...
                    t.every(function(t) {
                        ...
                        for (var e, n = 0; n < t.addedNodes.length; ++n)
                            if (e = t.addedNodes[n],
                            e.outerHTML && e.outerHTML.indexOf("data-uk-") !== -1)
                                return (i = !0) && !1;
                        return !0
                    }),
                    i && e()
...
function(t) {
    ...
    function e() {
        c = null,
        u.last && (void 0 !== u.el && u.el.trigger("longTap"),
        u = {})
    }
    function n() {
        c && clearTimeout(c),
    ...
    if (!t.fn.swipeLeft) {
        ...
        t(function() {
            ...
            t(document).on("MSGestureEnd gestureend", function(t) {
                ...
                i && void 0 !== u.el && (u.el.trigger("swipe"),
                u.el.trigger("swipe" + i))
                ...
                u.x2 = m.pageX,
                u.y2 = m.pageY,
                g += Math.abs(u.x1 - u.x2),
                v += Math.abs(u.y1 - u.y2))
            }).on("touchend MSPointerUp pointerup", function(e) {
                ("MSPointerUp" != e.type || s(e.originalEvent)) && (n(),
                u.x2 && Math.abs(u.x1 - u.x2) > 30 || u.y2 && Math.abs(u.y1 - u.y2) > 30 ? l = setTimeout(function() {
                    void 0 !== u.el && (u.el.trigger("swipe"),
                    u.el.trigger("swipe" + i(u.x1, u.x2, u.y1, u.y2))),
                    u = {}
                }, 0) : "last"in u && (isNaN(g) || g < 30 && v < 30 ? r = setTimeout(function() {
                    var i = t.Event("tap");
                    i.cancelTouch = o,
                    void 0 !== u.el && u.el.trigger(i),
                    u.isDoubleTap ? (void 0 !== u.el && u.el.trigger("doubleTap"),
                    u = {}) : a = setTimeout(function() {
                        a = null,
                        void 0 !== u.el && u.el.trigger("singleTap"),
                        u = {}
                    }, 250)
                }, 0) : u = {},
                g = v = 0))
        ...
        init: function() {
            var i, e = this, o = this.options.cls.split(/,/), s = function() {
                ...
                n.each(function(n) {
                    ...
                    !c || l || r.data("scrollspy-idle") || (i || (r.addClass(e.options.initcls),
                    e.offset = r.offset(),
                    i = !0,
                    ...
                    s++),
                    !c && l && e.options.repeat && (r.data("scrollspy-idle") && (clearTimeout(r.data("scrollspy-idle")),
                    r.data("scrollspy-idle", !1)),
        ...
        init: function() {
            var e, n = [], o = this.find("a[href^='#']").each(function() {
                ...
                if (e.length) {
                    ...
                    s = o.filter("a[href='#" + u.attr("id") + "']").closest(l).addClass(r)) : s = o.removeClass(r).filter("a[href='#" + u.attr("id") + "']").addClass(r),
    ...
    t.component("dropdown", {
        ...
        init: function() {
            ...
            "click" == this.options.mode || t.support.touch ? this.on("click.uk.dropdown", function(e) {
                ...
                n && n == i ? void ((!i.dropdown.find(e.target).length || o.is(".uk-dropdown-close") || o.parents(".uk-dropdown-close").length) && i.hide()) : ((o.is("a[href='#']") || o.parent().is("a[href='#']")) && e.preventDefault(),
                void i.show())
            })
        },
        show: function() {
        ...
        checkDimensions: function() {
            if (this.dropdown.length) {
                ...
                this.justified && this.justified.length)
                    ...
                    this.checkBoundary(n.left + h.left, n.top + h.top, r, l, c) && (e = d.split("-"),
                    h = u[d] ? u[d] : u["bottom-left"]))
                }
        ...
        checkBoundary: function(i, e, n, o, s) {
            var a = "";
            return (i < 0 || i - t.$win.scrollLeft() + n > s) && (a += "x"),
...
function(t) {
    ...
    function i(i, e) {
        if (e)
            return "object" == typeof i ? (i = i instanceof jQuery ? i : t.$(i),
...
function(t) {
    ...
    t.component("switcher", {
        ...
        show: function(n, o) {
            if (!this.animating) {
                ...
                isNaN(n) ? n = t.$(n) : (n = n < 0 ? s.length - 1 : n,
                n = s.eq(s[n] ? n : 0));
                var a = this
                  , r = t.$(n)
    ...
    e = {
        ...
        "slide-vertical": function(t, e, n) {
            ...
            return t && t.index() > e.index() && o.reverse(),
            i.apply(this, [o, t, e])
        },
...
!function(t) {
    ...
    t.fn.socialButtons = function(a) {
        ...
        a.twitter || a.plusone || a.facebook ? (a.twitter && !e.twitter && (e.twitter = t.getScript("//platform.twitter.com/widgets.js")),
        ...
        function(t, e, a) {
            ...
            t.getElementById(a) || (o = t.createElement(e),
            o.id = a,
            o.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.0",
...
(function(addon) {
    ...
    UI.component("sticky", {
        ...
        init: function() {
            var stickyId = this.element.attr("id") || "s" + Math.ceil(Math.random() * 1e4)
